                                ...
                                <div class="card card-custom">
                                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                        <div class="card-title">
                                            <h3 class="card-label">Appointment
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
                                            <thead>
                                                <tr>
                                                    <th title="Field #1">Appointment No.</th>
                                            ...
                                            @if($data??'')
                                                @foreach($data as $key=>$value)
                                                    <tr>
                                                        ...
                                                        <td>
                                                                <a href="appointment/{{$value->id}}/edit" class="btn btn-primary btn-sm" >Update</a>
                                                                <button type="button" data-id="{{$value->id}}" onClick="delete_btn(this)" class="btn btn-danger btn-sm">Cancel</button>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            @endif
