         ...
         <div class="card-body">
            <div class="form-group row">
               <div class="col-lg-6">
                  ...
                  <input type="text" name="service_title" class="form-control reset" value="{{$data->service_title}}" placeholder=" Enter Service Title."/>
                  @error('service_title')
               ...
               <!-- <div class="col-lg-6">
                  ...
                  <input type="text" name="service_cost_range" class="form-control reset" value="{{$data->service_cost_range}}" placeholder=" Enter Service Cost Range."/>
